...
public class SscApplication {
    ...
    public CommandLineRunner initData(CategoryRepository categoryRepository, QuestionRepository questionRepository) {
        return args -> {
            ...
            // 填空题
            CompletionQuestion completionQuestion1 = FactoryService.createCompletionQuestion("填空题1", category1, 1.0, "gender == T(com.channelwin.ssc.Gender).MALE", new ArrayList<ValidateRule>());
